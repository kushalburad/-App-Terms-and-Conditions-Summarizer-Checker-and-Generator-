...
public class CheckerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View root = inflater.inflate(R.layout.fragment_checker, container, false);
        final Button btnSum;
        btnSum = (Button)root.findViewById(R.id.btnCheck);
    ...
    public void myWork() {
        ...
        try {
            ...
            Dialog.setMessage("Checking Terms...");
            Dialog.show();
            ...
            new AsyncTask<Object, Object, Object>() {
                        ...
                        recognizer.processImage(image).addOnSuccessListener(new OnSuccessListener<FirebaseVisionText>() {
                            ...
                            public void onSuccess(FirebaseVisionText firebaseVisionText) {
                                ...
                                if (!detectedtext.trim().equals("")) {
                                    if(wordcount<=100)
                                        newop = "Image can't be checked for critical info.";
                                    else {
                                        Python py = Python.getInstance();
                                        final PyObject pyobj = py.getModule("textblob_checker");
                ...
                protected void onPostExecute(Object result) {
                    ...
                    Intent intent = new Intent(getActivity(), CheckerOP.class);
